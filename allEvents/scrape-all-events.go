...
func findMeetings(db *sql.DB) {
	...
	// Start scraping on https://pattersonca.iqm2.com/Citizens/calendar.aspx?From=1/1/1900&To=12/31/9999
	c.Visit("https://pattersonca.iqm2.com/Citizens/calendar.aspx?From=1/1/1900&To=12/31/9999")
}
